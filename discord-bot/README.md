...
A Discord bot that provides intelligent answers from your documentation using the Ragussy platform APIs.
...
RAG_API_URL=http://localhost:8000/api/ragussy
RAG_API_KEY=
BOT_NAME=Docs Bot
...
- Recommended proxy mode: `RAG_API_URL=http://localhost:8000/api/ragussy` (no API key needed; backend handles Ragussy auth)
- Direct Ragussy mode: `RAG_API_URL=http://localhost:3001/api` and set `RAG_API_KEY`
...
| `RAG_API_URL` | Ragussy API endpoint | `http://localhost:8000/api/ragussy` |
| `RAG_API_KEY` | Ragussy API key | Optional |
